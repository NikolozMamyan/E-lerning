...
final class Version20260917120000 extends AbstractMigration
{
    ...
    {
        return 'Add and populate the course creation date';
    }

    public function up(Schema $schema): void
    {
        $this->addSql("ALTER TABLE course ADD created_at DATETIME DEFAULT NULL COMMENT '(DC2Type:datetime_immutable)'");
        $this->addSql(<<<'SQL'
            UPDATE course
